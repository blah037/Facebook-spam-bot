...
username = 'p.buyantsog'
password = 'finitY_89024'

# Your search query
search_query = 'test85980'
...
time.sleep(20)  # Wait for the login process to complete
...
profile_link = driver.find_element(By.XPATH, "//img[@alt='Test85980, profile picture']")
profile_link.click()
